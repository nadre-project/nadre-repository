...
.. seealso::
	.. hlist::
		...
		* About `Invenio <https://github.com/inveniosoftware/invenio/tree/v1.2.1>`_

		* Invenio `Documentation <https://invenio-software.org/legacy/>`_
...
7) Put your `bibsched <https://github.com/osct/openaccessrepository/blob/master/docs/figures/bibsched.rst>`_  queue back to automatic mode, and you are done. (See more: `Howto Run Invenio installation <http://nadre.ethernet.edu.et/help/admin/howto-run>`_ )
